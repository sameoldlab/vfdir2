...
type starterPackWithMembership$schematype =
  typeof _starterPackWithMembershipSchema;
...
export interface StarterPackWithMembership extends v.InferInput<
  typeof starterPackWithMembershipSchema
> {}
