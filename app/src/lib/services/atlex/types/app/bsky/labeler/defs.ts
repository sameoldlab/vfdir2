...
const _labelerPoliciesSchema = /*#__PURE__*/ v.object({
  $type: /*#__PURE__*/ v.optional(
    /*#__PURE__*/ v.literal("app.bsky.labeler.defs#labelerPolicies"),
  ),
  /**
  ...
  get labelValueDefinitions() {
    return /*#__PURE__*/ v.optional(
      /*#__PURE__*/ v.array(ComAtprotoLabelDefs.labelValueDefinitionSchema),
    );
  },
  /**
...
const _labelerViewSchema = /*#__PURE__*/ v.object({
  $type: /*#__PURE__*/ v.optional(
    /*#__PURE__*/ v.literal("app.bsky.labeler.defs#labelerView"),
  ),
...
const _labelerViewDetailedSchema = /*#__PURE__*/ v.object({
  $type: /*#__PURE__*/ v.optional(
    /*#__PURE__*/ v.literal("app.bsky.labeler.defs#labelerViewDetailed"),
  ),
  cid: /*#__PURE__*/ v.cidString(),
  get creator() {
    return AppBskyActorDefs.profileViewSchema;
  ...
  get reasonTypes() {
    return /*#__PURE__*/ v.optional(
      /*#__PURE__*/ v.array(ComAtprotoModerationDefs.reasonTypeSchema),
    );
  },
  /**
   * Set of record types (collection NSIDs) which can be reported to this service. If not defined (distinct from empty array), default is any record type.
   */
  subjectCollections: /*#__PURE__*/ v.optional(
  ...
  get subjectTypes() {
    return /*#__PURE__*/ v.optional(
      /*#__PURE__*/ v.array(ComAtprotoModerationDefs.subjectTypeSchema),
    );
  },
  uri: /*#__PURE__*/ v.resourceUriString(),
  get viewer() {
...
const _labelerViewerStateSchema = /*#__PURE__*/ v.object({
  $type: /*#__PURE__*/ v.optional(
    /*#__PURE__*/ v.literal("app.bsky.labeler.defs#labelerViewerState"),
  ),
...
export const labelerPoliciesSchema =
  _labelerPoliciesSchema as labelerPoliciesSchema;
export const labelerViewSchema = _labelerViewSchema as labelerViewSchema;
export const labelerViewDetailedSchema =
  _labelerViewDetailedSchema as labelerViewDetailedSchema;
export const labelerViewerStateSchema =
  _labelerViewerStateSchema as labelerViewerStateSchema;

export interface LabelerPolicies extends v.InferInput<
  typeof labelerPoliciesSchema
> {}
export interface LabelerView extends v.InferInput<typeof labelerViewSchema> {}
export interface LabelerViewDetailed extends v.InferInput<
  typeof labelerViewDetailedSchema
> {}
export interface LabelerViewerState extends v.InferInput<
  typeof labelerViewerStateSchema
> {}
