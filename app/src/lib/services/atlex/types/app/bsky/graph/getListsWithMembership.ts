  ...
  "app.bsky.graph.getListsWithMembership",
  {
    params: /*#__PURE__*/ v.object({
      ...
      purposes: /*#__PURE__*/ v.optional(
        /*#__PURE__*/ v.array(
          /*#__PURE__*/ v.string<"curatelist" | "modlist" | (string & {})>(),
        ),
      ),
    }),
    output: {
...
export const listWithMembershipSchema =
  _listWithMembershipSchema as listWithMembershipSchema;
export const mainSchema = _mainSchema as mainSchema;

export interface ListWithMembership extends v.InferInput<
  typeof listWithMembershipSchema
> {}
