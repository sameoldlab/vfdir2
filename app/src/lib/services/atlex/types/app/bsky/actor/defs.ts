...
const _declaredAgePrefSchema = /*#__PURE__*/ v.object({
  $type: /*#__PURE__*/ v.optional(
    /*#__PURE__*/ v.literal("app.bsky.actor.defs#declaredAgePref"),
  ),
  /**
...
const _knownFollowersSchema = /*#__PURE__*/ v.object({
  $type: /*#__PURE__*/ v.optional(
    /*#__PURE__*/ v.literal("app.bsky.actor.defs#knownFollowers"),
  ),
  ...
  get followers() {
    return /*#__PURE__*/ v.constrain(
      /*#__PURE__*/ v.array(profileViewBasicSchema),
...
const _profileAssociatedSchema = /*#__PURE__*/ v.object({
  $type: /*#__PURE__*/ v.optional(
    /*#__PURE__*/ v.literal("app.bsky.actor.defs#profileAssociated"),
  ),
  get activitySubscription() {
    return /*#__PURE__*/ v.optional(
      profileAssociatedActivitySubscriptionSchema,
    );
  },
  get chat() {
...
const _profileAssociatedActivitySubscriptionSchema = /*#__PURE__*/ v.object({
  ...
  allowSubscriptions: /*#__PURE__*/ v.string<
    "followers" | "mutuals" | "none" | (string & {})
  >(),
});
const _profileAssociatedChatSchema = /*#__PURE__*/ v.object({
  $type: /*#__PURE__*/ v.optional(
    /*#__PURE__*/ v.literal("app.bsky.actor.defs#profileAssociatedChat"),
  ),
  allowIncoming: /*#__PURE__*/ v.string<
    "all" | "following" | "none" | (string & {})
  >(),
});
const _profileViewSchema = /*#__PURE__*/ v.object({
  $type: /*#__PURE__*/ v.optional(
    /*#__PURE__*/ v.literal("app.bsky.actor.defs#profileView"),
  ),
  get associated() {
...
const _profileViewBasicSchema = /*#__PURE__*/ v.object({
  $type: /*#__PURE__*/ v.optional(
    /*#__PURE__*/ v.literal("app.bsky.actor.defs#profileViewBasic"),
  ),
  get associated() {
    return /*#__PURE__*/ v.optional(profileAssociatedSchema);
  },
...
const _profileViewDetailedSchema = /*#__PURE__*/ v.object({
  $type: /*#__PURE__*/ v.optional(
    /*#__PURE__*/ v.literal("app.bsky.actor.defs#profileViewDetailed"),
  ),
  get associated() {
    return /*#__PURE__*/ v.optional(profileAssociatedSchema);
  },
...
const _statusViewSchema = /*#__PURE__*/ v.object({
  $type: /*#__PURE__*/ v.optional(
    /*#__PURE__*/ v.literal("app.bsky.actor.defs#statusView"),
  ),
  /**
  ...
  get embed() {
    return /*#__PURE__*/ v.optional(
      /*#__PURE__*/ v.variant([AppBskyEmbedExternal.viewSchema]),
    );
  },
  /**
  ...
  status: /*#__PURE__*/ v.string<
    "app.bsky.actor.status#live" | (string & {})
  >(),
});
...
const _verificationStateSchema = /*#__PURE__*/ v.object({
  $type: /*#__PURE__*/ v.optional(
    /*#__PURE__*/ v.literal("app.bsky.actor.defs#verificationState"),
  ),
  /**
   * The user's status as a trusted verifier.
   */
  trustedVerifierStatus: /*#__PURE__*/ v.string<
    "invalid" | "none" | "valid" | (string & {})
  >(),
  /**
...
const _verificationViewSchema = /*#__PURE__*/ v.object({
  $type: /*#__PURE__*/ v.optional(
    /*#__PURE__*/ v.literal("app.bsky.actor.defs#verificationView"),
  ),
  /**
...
const _viewerStateSchema = /*#__PURE__*/ v.object({
  $type: /*#__PURE__*/ v.optional(
    /*#__PURE__*/ v.literal("app.bsky.actor.defs#viewerState"),
  ),
  /**
  ...
  get activitySubscription() {
    return /*#__PURE__*/ v.optional(
      AppBskyNotificationDefs.activitySubscriptionSchema,
    );
  },
...
type profileAssociatedActivitySubscription$schematype =
  typeof _profileAssociatedActivitySubscriptionSchema;
...
export const declaredAgePrefSchema =
  _declaredAgePrefSchema as declaredAgePrefSchema;
...
export const knownFollowersSchema =
  _knownFollowersSchema as knownFollowersSchema;
...
export const profileAssociatedSchema =
  _profileAssociatedSchema as profileAssociatedSchema;
...
export const profileAssociatedChatSchema =
  _profileAssociatedChatSchema as profileAssociatedChatSchema;
...
export const verificationStateSchema =
  _verificationStateSchema as verificationStateSchema;
export const verificationViewSchema =
  _verificationViewSchema as verificationViewSchema;
export const viewerStateSchema = _viewerStateSchema as viewerStateSchema;

export interface AdultContentPref extends v.InferInput<
  typeof adultContentPrefSchema
> {}
export interface BskyAppProgressGuide extends v.InferInput<
  typeof bskyAppProgressGuideSchema
> {}
export interface BskyAppStatePref extends v.InferInput<
  typeof bskyAppStatePrefSchema
> {}
export interface ContentLabelPref extends v.InferInput<
  typeof contentLabelPrefSchema
> {}
export interface DeclaredAgePref extends v.InferInput<
  typeof declaredAgePrefSchema
> {}
export interface FeedViewPref extends v.InferInput<typeof feedViewPrefSchema> {}
export interface HiddenPostsPref extends v.InferInput<
  typeof hiddenPostsPrefSchema
> {}
export interface InterestsPref extends v.InferInput<
  typeof interestsPrefSchema
> {}
export interface KnownFollowers extends v.InferInput<
  typeof knownFollowersSchema
> {}
export interface LabelerPrefItem extends v.InferInput<
  typeof labelerPrefItemSchema
> {}
...
export interface MutedWordsPref extends v.InferInput<
  typeof mutedWordsPrefSchema
> {}
export interface Nux extends v.InferInput<typeof nuxSchema> {}
export interface PersonalDetailsPref extends v.InferInput<
  typeof personalDetailsPrefSchema
> {}
export interface PostInteractionSettingsPref extends v.InferInput<
  typeof postInteractionSettingsPrefSchema
> {}
export interface Preferences extends v.InferInput<typeof preferencesSchema> {}
export interface ProfileAssociated extends v.InferInput<
  typeof profileAssociatedSchema
> {}
...
> {}
export interface ProfileAssociatedChat extends v.InferInput<
  typeof profileAssociatedChatSchema
> {}
...
export interface SavedFeedsPref extends v.InferInput<
  typeof savedFeedsPrefSchema
> {}
export interface SavedFeedsPrefV2 extends v.InferInput<
  typeof savedFeedsPrefV2Schema
> {}
export interface StatusView extends v.InferInput<typeof statusViewSchema> {}
export interface ThreadViewPref extends v.InferInput<
  typeof threadViewPrefSchema
> {}
export interface VerificationPrefs extends v.InferInput<
  typeof verificationPrefsSchema
> {}
export interface VerificationState extends v.InferInput<
  typeof verificationStateSchema
> {}
export interface VerificationView extends v.InferInput<
  typeof verificationViewSchema
> {}
