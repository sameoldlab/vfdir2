...
const _accessSchema = /*#__PURE__*/ v.string<
  "full" | "none" | "safe" | "unknown" | (string & {})
>();
const _configSchema = /*#__PURE__*/ v.object({
  $type: /*#__PURE__*/ v.optional(
    /*#__PURE__*/ v.literal("app.bsky.ageassurance.defs#config"),
  ),
  /**
...
const _configRegionSchema = /*#__PURE__*/ v.object({
  $type: /*#__PURE__*/ v.optional(
    /*#__PURE__*/ v.literal("app.bsky.ageassurance.defs#configRegion"),
  ),
  /**
...
const _eventSchema = /*#__PURE__*/ v.object({
  $type: /*#__PURE__*/ v.optional(
    /*#__PURE__*/ v.literal("app.bsky.ageassurance.defs#event"),
  ),
  /**
...
const _stateSchema = /*#__PURE__*/ v.object({
  $type: /*#__PURE__*/ v.optional(
    /*#__PURE__*/ v.literal("app.bsky.ageassurance.defs#state"),
  ),
  get access() {
    return accessSchema;
  },
...
const _stateMetadataSchema = /*#__PURE__*/ v.object({
  $type: /*#__PURE__*/ v.optional(
    /*#__PURE__*/ v.literal("app.bsky.ageassurance.defs#stateMetadata"),
  ),
  /**
...
type configRegionRuleIfAccountNewerThan$schematype =
  typeof _configRegionRuleIfAccountNewerThanSchema;
type configRegionRuleIfAccountOlderThan$schematype =
  typeof _configRegionRuleIfAccountOlderThanSchema;
type configRegionRuleIfAssuredOverAge$schematype =
  typeof _configRegionRuleIfAssuredOverAgeSchema;
type configRegionRuleIfAssuredUnderAge$schematype =
  typeof _configRegionRuleIfAssuredUnderAgeSchema;
type configRegionRuleIfDeclaredOverAge$schematype =
  typeof _configRegionRuleIfDeclaredOverAgeSchema;
type configRegionRuleIfDeclaredUnderAge$schematype =
  typeof _configRegionRuleIfDeclaredUnderAgeSchema;
...
export const configRegionRuleDefaultSchema =
  _configRegionRuleDefaultSchema as configRegionRuleDefaultSchema;
...
export interface ConfigRegionRuleDefault extends v.InferInput<
  typeof configRegionRuleDefaultSchema
> {}
...
export interface StateMetadata extends v.InferInput<
  typeof stateMetadataSchema
> {}
