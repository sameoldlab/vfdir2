...
const _curatelistSchema = /*#__PURE__*/ v.literal(
  "app.bsky.graph.defs#curatelist",
);
const _listItemViewSchema = /*#__PURE__*/ v.object({
  $type: /*#__PURE__*/ v.optional(
    /*#__PURE__*/ v.literal("app.bsky.graph.defs#listItemView"),
  ),
  get subject() {
...
const _listViewSchema = /*#__PURE__*/ v.object({
  $type: /*#__PURE__*/ v.optional(
    /*#__PURE__*/ v.literal("app.bsky.graph.defs#listView"),
  ),
...
const _listViewBasicSchema = /*#__PURE__*/ v.object({
  $type: /*#__PURE__*/ v.optional(
    /*#__PURE__*/ v.literal("app.bsky.graph.defs#listViewBasic"),
  ),
  avatar: /*#__PURE__*/ v.optional(/*#__PURE__*/ v.genericUriString()),
  cid: /*#__PURE__*/ v.cidString(),
...
const _listViewerStateSchema = /*#__PURE__*/ v.object({
  $type: /*#__PURE__*/ v.optional(
    /*#__PURE__*/ v.literal("app.bsky.graph.defs#listViewerState"),
  ),
...
const _notFoundActorSchema = /*#__PURE__*/ v.object({
  $type: /*#__PURE__*/ v.optional(
    /*#__PURE__*/ v.literal("app.bsky.graph.defs#notFoundActor"),
  ),
  actor: /*#__PURE__*/ v.actorIdentifierString(),
  notFound: /*#__PURE__*/ v.literal(true),
});
const _referencelistSchema = /*#__PURE__*/ v.literal(
  "app.bsky.graph.defs#referencelist",
);
const _relationshipSchema = /*#__PURE__*/ v.object({
  $type: /*#__PURE__*/ v.optional(
    /*#__PURE__*/ v.literal("app.bsky.graph.defs#relationship"),
  ),
  /**
...
const _starterPackViewSchema = /*#__PURE__*/ v.object({
  $type: /*#__PURE__*/ v.optional(
    /*#__PURE__*/ v.literal("app.bsky.graph.defs#starterPackView"),
  ),
  cid: /*#__PURE__*/ v.cidString(),
  get creator() {
  ...
  get feeds() {
    return /*#__PURE__*/ v.optional(
      /*#__PURE__*/ v.constrain(
        /*#__PURE__*/ v.array(AppBskyFeedDefs.generatorViewSchema),
...
const _starterPackViewBasicSchema = /*#__PURE__*/ v.object({
  $type: /*#__PURE__*/ v.optional(
    /*#__PURE__*/ v.literal("app.bsky.graph.defs#starterPackViewBasic"),
  ),
  cid: /*#__PURE__*/ v.cidString(),
  get creator() {
    return AppBskyActorDefs.profileViewBasicSchema;
...
export const listViewerStateSchema =
  _listViewerStateSchema as listViewerStateSchema;
...
export const starterPackViewSchema =
  _starterPackViewSchema as starterPackViewSchema;
export const starterPackViewBasicSchema =
  _starterPackViewBasicSchema as starterPackViewBasicSchema;
...
export interface ListViewBasic extends v.InferInput<
  typeof listViewBasicSchema
> {}
export interface ListViewerState extends v.InferInput<
  typeof listViewerStateSchema
> {}
export type Modlist = v.InferInput<typeof modlistSchema>;
export interface NotFoundActor extends v.InferInput<
  typeof notFoundActorSchema
> {}
...
export interface StarterPackView extends v.InferInput<
  typeof starterPackViewSchema
> {}
export interface StarterPackViewBasic extends v.InferInput<
  typeof starterPackViewBasicSchema
> {}
