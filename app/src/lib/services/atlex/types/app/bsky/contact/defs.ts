...
const _matchAndContactIndexSchema = /*#__PURE__*/ v.object({
  $type: /*#__PURE__*/ v.optional(
    /*#__PURE__*/ v.literal("app.bsky.contact.defs#matchAndContactIndex"),
  ),
  /**
   ...
   * @maximum 999
   */
  contactIndex: /*#__PURE__*/ v.constrain(/*#__PURE__*/ v.integer(), [
    /*#__PURE__*/ v.integerRange(0, 999),
  ]),
  /**
...
const _notificationSchema = /*#__PURE__*/ v.object({
  $type: /*#__PURE__*/ v.optional(
    /*#__PURE__*/ v.literal("app.bsky.contact.defs#notification"),
  ),
  /**
...
const _syncStatusSchema = /*#__PURE__*/ v.object({
  $type: /*#__PURE__*/ v.optional(
    /*#__PURE__*/ v.literal("app.bsky.contact.defs#syncStatus"),
  ),
  /**
...
export const matchAndContactIndexSchema =
  _matchAndContactIndexSchema as matchAndContactIndexSchema;
...
export interface MatchAndContactIndex extends v.InferInput<
  typeof matchAndContactIndexSchema
> {}
