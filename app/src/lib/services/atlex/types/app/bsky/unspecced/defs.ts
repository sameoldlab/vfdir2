...
const _ageAssuranceEventSchema = /*#__PURE__*/ v.object({
  $type: /*#__PURE__*/ v.optional(
    /*#__PURE__*/ v.literal("app.bsky.unspecced.defs#ageAssuranceEvent"),
  ),
  /**
  ...
  status: /*#__PURE__*/ v.string<
    "assured" | "pending" | "unknown" | (string & {})
  >(),
});
const _ageAssuranceStateSchema = /*#__PURE__*/ v.object({
  $type: /*#__PURE__*/ v.optional(
    /*#__PURE__*/ v.literal("app.bsky.unspecced.defs#ageAssuranceState"),
  ),
  /**
   ...
   */
  status: /*#__PURE__*/ v.string<
    "assured" | "blocked" | "pending" | "unknown" | (string & {})
  >(),
});
const _skeletonSearchActorSchema = /*#__PURE__*/ v.object({
  $type: /*#__PURE__*/ v.optional(
    /*#__PURE__*/ v.literal("app.bsky.unspecced.defs#skeletonSearchActor"),
  ),
  did: /*#__PURE__*/ v.didString(),
});
const _skeletonSearchPostSchema = /*#__PURE__*/ v.object({
  $type: /*#__PURE__*/ v.optional(
    /*#__PURE__*/ v.literal("app.bsky.unspecced.defs#skeletonSearchPost"),
  ),
...
const _skeletonTrendSchema = /*#__PURE__*/ v.object({
  $type: /*#__PURE__*/ v.optional(
    /*#__PURE__*/ v.literal("app.bsky.unspecced.defs#skeletonTrend"),
  ),
  ...
  status: /*#__PURE__*/ v.optional(
    /*#__PURE__*/ v.string<"hot" | (string & {})>(),
  ),
  topic: /*#__PURE__*/ v.string(),
});
const _threadItemBlockedSchema = /*#__PURE__*/ v.object({
  $type: /*#__PURE__*/ v.optional(
    /*#__PURE__*/ v.literal("app.bsky.unspecced.defs#threadItemBlocked"),
  ),
  get author() {
...
const _threadItemNotFoundSchema = /*#__PURE__*/ v.object({
  $type: /*#__PURE__*/ v.optional(
    /*#__PURE__*/ v.literal("app.bsky.unspecced.defs#threadItemNotFound"),
  ),
});
const _threadItemPostSchema = /*#__PURE__*/ v.object({
  $type: /*#__PURE__*/ v.optional(
    /*#__PURE__*/ v.literal("app.bsky.unspecced.defs#threadItemPost"),
  ),
  /**
...
const _trendViewSchema = /*#__PURE__*/ v.object({
  $type: /*#__PURE__*/ v.optional(
    /*#__PURE__*/ v.literal("app.bsky.unspecced.defs#trendView"),
  ),
  get actors() {
...
const _trendingTopicSchema = /*#__PURE__*/ v.object({
  $type: /*#__PURE__*/ v.optional(
    /*#__PURE__*/ v.literal("app.bsky.unspecced.defs#trendingTopic"),
  ),
...
type skeletonSearchStarterPack$schematype =
  typeof _skeletonSearchStarterPackSchema;
...
type threadItemNoUnauthenticated$schematype =
  typeof _threadItemNoUnauthenticatedSchema;
...
export const ageAssuranceEventSchema =
  _ageAssuranceEventSchema as ageAssuranceEventSchema;
export const ageAssuranceStateSchema =
  _ageAssuranceStateSchema as ageAssuranceStateSchema;
export const skeletonSearchActorSchema =
  _skeletonSearchActorSchema as skeletonSearchActorSchema;
export const skeletonSearchPostSchema =
  _skeletonSearchPostSchema as skeletonSearchPostSchema;
...
export const threadItemBlockedSchema =
  _threadItemBlockedSchema as threadItemBlockedSchema;
export const threadItemNoUnauthenticatedSchema =
  _threadItemNoUnauthenticatedSchema as threadItemNoUnauthenticatedSchema;
export const threadItemNotFoundSchema =
  _threadItemNotFoundSchema as threadItemNotFoundSchema;
export const threadItemPostSchema =
  _threadItemPostSchema as threadItemPostSchema;
...
export interface AgeAssuranceEvent extends v.InferInput<
  typeof ageAssuranceEventSchema
> {}
export interface AgeAssuranceState extends v.InferInput<
  typeof ageAssuranceStateSchema
> {}
export interface SkeletonSearchActor extends v.InferInput<
  typeof skeletonSearchActorSchema
> {}
export interface SkeletonSearchPost extends v.InferInput<
  typeof skeletonSearchPostSchema
> {}
export interface SkeletonSearchStarterPack extends v.InferInput<
  typeof skeletonSearchStarterPackSchema
> {}
export interface SkeletonTrend extends v.InferInput<
  typeof skeletonTrendSchema
> {}
export interface ThreadItemBlocked extends v.InferInput<
  typeof threadItemBlockedSchema
> {}
export interface ThreadItemNoUnauthenticated extends v.InferInput<
  typeof threadItemNoUnauthenticatedSchema
> {}
export interface ThreadItemNotFound extends v.InferInput<
  typeof threadItemNotFoundSchema
> {}
export interface ThreadItemPost extends v.InferInput<
  typeof threadItemPostSchema
> {}
export interface TrendView extends v.InferInput<typeof trendViewSchema> {}
export interface TrendingTopic extends v.InferInput<
  typeof trendingTopicSchema
> {}
