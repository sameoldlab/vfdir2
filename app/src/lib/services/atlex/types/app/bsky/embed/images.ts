...
const _imageSchema = /*#__PURE__*/ v.object({
  $type: /*#__PURE__*/ v.optional(
    /*#__PURE__*/ v.literal("app.bsky.embed.images#image"),
  ),
  /**
...
const _mainSchema = /*#__PURE__*/ v.object({
  $type: /*#__PURE__*/ v.optional(
    /*#__PURE__*/ v.literal("app.bsky.embed.images"),
  ),
  /**
   * @maxLength 4
   */
  get images() {
    return /*#__PURE__*/ v.constrain(/*#__PURE__*/ v.array(imageSchema), [
...
const _viewSchema = /*#__PURE__*/ v.object({
  $type: /*#__PURE__*/ v.optional(
    /*#__PURE__*/ v.literal("app.bsky.embed.images#view"),
  ),
  /**
   * @maxLength 4
   */
...
const _viewImageSchema = /*#__PURE__*/ v.object({
  $type: /*#__PURE__*/ v.optional(
    /*#__PURE__*/ v.literal("app.bsky.embed.images#viewImage"),
  ),
  /**
   * Alt text description of the image, for accessibility.
   */
