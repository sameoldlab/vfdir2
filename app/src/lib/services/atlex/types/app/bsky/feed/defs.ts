...
const _blockedAuthorSchema = /*#__PURE__*/ v.object({
  $type: /*#__PURE__*/ v.optional(
    /*#__PURE__*/ v.literal("app.bsky.feed.defs#blockedAuthor"),
  ),
...
const _blockedPostSchema = /*#__PURE__*/ v.object({
  $type: /*#__PURE__*/ v.optional(
    /*#__PURE__*/ v.literal("app.bsky.feed.defs#blockedPost"),
  ),
  get author() {
...
const _clickthroughAuthorSchema = /*#__PURE__*/ v.literal(
  "app.bsky.feed.defs#clickthroughAuthor",
);
const _clickthroughEmbedSchema = /*#__PURE__*/ v.literal(
  "app.bsky.feed.defs#clickthroughEmbed",
);
const _clickthroughItemSchema = /*#__PURE__*/ v.literal(
  "app.bsky.feed.defs#clickthroughItem",
);
const _clickthroughReposterSchema = /*#__PURE__*/ v.literal(
  "app.bsky.feed.defs#clickthroughReposter",
);
const _contentModeUnspecifiedSchema = /*#__PURE__*/ v.literal(
  "app.bsky.feed.defs#contentModeUnspecified",
);
const _contentModeVideoSchema = /*#__PURE__*/ v.literal(
  "app.bsky.feed.defs#contentModeVideo",
);
const _feedViewPostSchema = /*#__PURE__*/ v.object({
  $type: /*#__PURE__*/ v.optional(
    /*#__PURE__*/ v.literal("app.bsky.feed.defs#feedViewPost"),
  ),
  /**
  ...
  get reason() {
    return /*#__PURE__*/ v.optional(
      /*#__PURE__*/ v.variant([reasonPinSchema, reasonRepostSchema]),
    );
  },
  get reply() {
...
const _generatorViewSchema = /*#__PURE__*/ v.object({
  $type: /*#__PURE__*/ v.optional(
    /*#__PURE__*/ v.literal("app.bsky.feed.defs#generatorView"),
  ),
...
const _generatorViewerStateSchema = /*#__PURE__*/ v.object({
  $type: /*#__PURE__*/ v.optional(
    /*#__PURE__*/ v.literal("app.bsky.feed.defs#generatorViewerState"),
  ),
  like: /*#__PURE__*/ v.optional(/*#__PURE__*/ v.resourceUriString()),
});
const _interactionSchema = /*#__PURE__*/ v.object({
  $type: /*#__PURE__*/ v.optional(
    /*#__PURE__*/ v.literal("app.bsky.feed.defs#interaction"),
  ),
...
const _interactionLikeSchema = /*#__PURE__*/ v.literal(
  "app.bsky.feed.defs#interactionLike",
);
const _interactionQuoteSchema = /*#__PURE__*/ v.literal(
  "app.bsky.feed.defs#interactionQuote",
);
const _interactionReplySchema = /*#__PURE__*/ v.literal(
  "app.bsky.feed.defs#interactionReply",
);
const _interactionRepostSchema = /*#__PURE__*/ v.literal(
  "app.bsky.feed.defs#interactionRepost",
);
const _interactionSeenSchema = /*#__PURE__*/ v.literal(
  "app.bsky.feed.defs#interactionSeen",
);
const _interactionShareSchema = /*#__PURE__*/ v.literal(
  "app.bsky.feed.defs#interactionShare",
);
const _notFoundPostSchema = /*#__PURE__*/ v.object({
  $type: /*#__PURE__*/ v.optional(
    /*#__PURE__*/ v.literal("app.bsky.feed.defs#notFoundPost"),
  ),
...
const _postViewSchema = /*#__PURE__*/ v.object({
  $type: /*#__PURE__*/ v.optional(
    /*#__PURE__*/ v.literal("app.bsky.feed.defs#postView"),
  ),
  get author() {
...
const _reasonPinSchema = /*#__PURE__*/ v.object({
  $type: /*#__PURE__*/ v.optional(
    /*#__PURE__*/ v.literal("app.bsky.feed.defs#reasonPin"),
  ),
});
const _reasonRepostSchema = /*#__PURE__*/ v.object({
  $type: /*#__PURE__*/ v.optional(
    /*#__PURE__*/ v.literal("app.bsky.feed.defs#reasonRepost"),
  ),
  get by() {
    return AppBskyActorDefs.profileViewBasicSchema;
  },
...
const _replyRefSchema = /*#__PURE__*/ v.object({
  $type: /*#__PURE__*/ v.optional(
    /*#__PURE__*/ v.literal("app.bsky.feed.defs#replyRef"),
  ),
  /**
...
const _requestLessSchema = /*#__PURE__*/ v.literal(
  "app.bsky.feed.defs#requestLess",
);
const _requestMoreSchema = /*#__PURE__*/ v.literal(
  "app.bsky.feed.defs#requestMore",
);
const _skeletonFeedPostSchema = /*#__PURE__*/ v.object({
  $type: /*#__PURE__*/ v.optional(
    /*#__PURE__*/ v.literal("app.bsky.feed.defs#skeletonFeedPost"),
  ),
  /**
  ...
  get reason() {
    return /*#__PURE__*/ v.optional(
      /*#__PURE__*/ v.variant([
        skeletonReasonPinSchema,
        skeletonReasonRepostSchema,
      ]),
    );
  },
});
...
const _threadgateViewSchema = /*#__PURE__*/ v.object({
  $type: /*#__PURE__*/ v.optional(
    /*#__PURE__*/ v.literal("app.bsky.feed.defs#threadgateView"),
  ),
  cid: /*#__PURE__*/ v.optional(/*#__PURE__*/ v.cidString()),
  get lists() {
    return /*#__PURE__*/ v.optional(
      /*#__PURE__*/ v.array(AppBskyGraphDefs.listViewBasicSchema),
    );
  },
...
const _viewerStateSchema = /*#__PURE__*/ v.object({
  $type: /*#__PURE__*/ v.optional(
    /*#__PURE__*/ v.literal("app.bsky.feed.defs#viewerState"),
  ),
...
export const clickthroughAuthorSchema =
  _clickthroughAuthorSchema as clickthroughAuthorSchema;
export const clickthroughEmbedSchema =
  _clickthroughEmbedSchema as clickthroughEmbedSchema;
export const clickthroughItemSchema =
  _clickthroughItemSchema as clickthroughItemSchema;
export const clickthroughReposterSchema =
  _clickthroughReposterSchema as clickthroughReposterSchema;
export const contentModeUnspecifiedSchema =
  _contentModeUnspecifiedSchema as contentModeUnspecifiedSchema;
export const contentModeVideoSchema =
  _contentModeVideoSchema as contentModeVideoSchema;
...
export const generatorViewerStateSchema =
  _generatorViewerStateSchema as generatorViewerStateSchema;
export const interactionSchema = _interactionSchema as interactionSchema;
export const interactionLikeSchema =
  _interactionLikeSchema as interactionLikeSchema;
export const interactionQuoteSchema =
  _interactionQuoteSchema as interactionQuoteSchema;
export const interactionReplySchema =
  _interactionReplySchema as interactionReplySchema;
export const interactionRepostSchema =
  _interactionRepostSchema as interactionRepostSchema;
export const interactionSeenSchema =
  _interactionSeenSchema as interactionSeenSchema;
export const interactionShareSchema =
  _interactionShareSchema as interactionShareSchema;
...
export const skeletonFeedPostSchema =
  _skeletonFeedPostSchema as skeletonFeedPostSchema;
...
export const threadViewPostSchema =
  _threadViewPostSchema as threadViewPostSchema;
export const threadgateViewSchema =
  _threadgateViewSchema as threadgateViewSchema;
export const viewerStateSchema = _viewerStateSchema as viewerStateSchema;

export interface BlockedAuthor extends v.InferInput<
  typeof blockedAuthorSchema
> {}
...
export type ClickthroughReposter = v.InferInput<
  typeof clickthroughReposterSchema
>;
export type ContentModeUnspecified = v.InferInput<
  typeof contentModeUnspecifiedSchema
>;
...
export interface GeneratorView extends v.InferInput<
  typeof generatorViewSchema
> {}
export interface GeneratorViewerState extends v.InferInput<
  typeof generatorViewerStateSchema
> {}
...
export interface SkeletonFeedPost extends v.InferInput<
  typeof skeletonFeedPostSchema
> {}
...
> {}
export interface ThreadContext extends v.InferInput<
  typeof threadContextSchema
> {}
export interface ThreadViewPost extends v.InferInput<
  typeof threadViewPostSchema
> {}
export interface ThreadgateView extends v.InferInput<
  typeof threadgateViewSchema
> {}
