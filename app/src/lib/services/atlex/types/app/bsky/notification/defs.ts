...
const _activitySubscriptionSchema = /*#__PURE__*/ v.object({
  $type: /*#__PURE__*/ v.optional(
    /*#__PURE__*/ v.literal("app.bsky.notification.defs#activitySubscription"),
  ),
...
const _chatPreferenceSchema = /*#__PURE__*/ v.object({
  $type: /*#__PURE__*/ v.optional(
    /*#__PURE__*/ v.literal("app.bsky.notification.defs#chatPreference"),
  ),
...
const _filterablePreferenceSchema = /*#__PURE__*/ v.object({
  $type: /*#__PURE__*/ v.optional(
    /*#__PURE__*/ v.literal("app.bsky.notification.defs#filterablePreference"),
  ),
...
const _preferenceSchema = /*#__PURE__*/ v.object({
  $type: /*#__PURE__*/ v.optional(
    /*#__PURE__*/ v.literal("app.bsky.notification.defs#preference"),
  ),
  list: /*#__PURE__*/ v.boolean(),
  push: /*#__PURE__*/ v.boolean(),
});
const _preferencesSchema = /*#__PURE__*/ v.object({
  $type: /*#__PURE__*/ v.optional(
    /*#__PURE__*/ v.literal("app.bsky.notification.defs#preferences"),
  ),
  get chat() {
...
const _recordDeletedSchema = /*#__PURE__*/ v.object({
  $type: /*#__PURE__*/ v.optional(
    /*#__PURE__*/ v.literal("app.bsky.notification.defs#recordDeleted"),
  ),
});
...
type subjectActivitySubscription$schematype =
...
export const activitySubscriptionSchema =
  _activitySubscriptionSchema as activitySubscriptionSchema;
export const chatPreferenceSchema =
  _chatPreferenceSchema as chatPreferenceSchema;
export const filterablePreferenceSchema =
  _filterablePreferenceSchema as filterablePreferenceSchema;
...
export interface ActivitySubscription extends v.InferInput<
  typeof activitySubscriptionSchema
> {}
export interface ChatPreference extends v.InferInput<
  typeof chatPreferenceSchema
> {}
export interface FilterablePreference extends v.InferInput<
  typeof filterablePreferenceSchema
> {}
...
export interface RecordDeleted extends v.InferInput<
  typeof recordDeletedSchema
> {}
export interface SubjectActivitySubscription extends v.InferInput<
  typeof subjectActivitySubscriptionSchema
> {}
