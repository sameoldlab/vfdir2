...
const _createSchema = /*#__PURE__*/ v.object({
  $type: /*#__PURE__*/ v.optional(
    /*#__PURE__*/ v.literal("com.atproto.repo.applyWrites#create"),
  ),
...
const _createResultSchema = /*#__PURE__*/ v.object({
  $type: /*#__PURE__*/ v.optional(
    /*#__PURE__*/ v.literal("com.atproto.repo.applyWrites#createResult"),
  ),
...
const _deleteSchema = /*#__PURE__*/ v.object({
  $type: /*#__PURE__*/ v.optional(
    /*#__PURE__*/ v.literal("com.atproto.repo.applyWrites#delete"),
  ),
  collection: /*#__PURE__*/ v.nsidString(),
...
const _deleteResultSchema = /*#__PURE__*/ v.object({
  $type: /*#__PURE__*/ v.optional(
    /*#__PURE__*/ v.literal("com.atproto.repo.applyWrites#deleteResult"),
  ),
});
    ...
    schema: /*#__PURE__*/ v.object({
      ...
      get writes() {
        return /*#__PURE__*/ v.array(
          /*#__PURE__*/ v.variant(
            [createSchema, deleteSchema, updateSchema],
            true,
          ),
        );
      },
    ...
    schema: /*#__PURE__*/ v.object({
      ...
      get results() {
        return /*#__PURE__*/ v.optional(
          /*#__PURE__*/ v.array(
            /*#__PURE__*/ v.variant(
              [createResultSchema, deleteResultSchema, updateResultSchema],
              true,
            ),
          ),
        );
...
const _updateSchema = /*#__PURE__*/ v.object({
  $type: /*#__PURE__*/ v.optional(
    /*#__PURE__*/ v.literal("com.atproto.repo.applyWrites#update"),
  ),
  collection: /*#__PURE__*/ v.nsidString(),
  rkey: /*#__PURE__*/ v.recordKeyString(),
  value: /*#__PURE__*/ v.unknown(),
...
const _updateResultSchema = /*#__PURE__*/ v.object({
  $type: /*#__PURE__*/ v.optional(
    /*#__PURE__*/ v.literal("com.atproto.repo.applyWrites#updateResult"),
  ),
  cid: /*#__PURE__*/ v.cidString(),
  uri: /*#__PURE__*/ v.resourceUriString(),
  validationStatus: /*#__PURE__*/ v.optional(
