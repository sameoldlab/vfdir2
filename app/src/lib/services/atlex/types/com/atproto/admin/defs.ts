...
const _accountViewSchema = /*#__PURE__*/ v.object({
  $type: /*#__PURE__*/ v.optional(
    /*#__PURE__*/ v.literal("com.atproto.admin.defs#accountView"),
  ),
  ...
  get invites() {
    return /*#__PURE__*/ v.optional(
      /*#__PURE__*/ v.array(ComAtprotoServerDefs.inviteCodeSchema),
    );
  },
  invitesDisabled: /*#__PURE__*/ v.optional(/*#__PURE__*/ v.boolean()),
  relatedRecords: /*#__PURE__*/ v.optional(
    /*#__PURE__*/ v.array(/*#__PURE__*/ v.unknown()),
  ),
  get threatSignatures() {
    return /*#__PURE__*/ v.optional(
      /*#__PURE__*/ v.array(threatSignatureSchema),
    );
  },
});
const _repoBlobRefSchema = /*#__PURE__*/ v.object({
  $type: /*#__PURE__*/ v.optional(
    /*#__PURE__*/ v.literal("com.atproto.admin.defs#repoBlobRef"),
  ),
...
const _repoRefSchema = /*#__PURE__*/ v.object({
  $type: /*#__PURE__*/ v.optional(
    /*#__PURE__*/ v.literal("com.atproto.admin.defs#repoRef"),
  ),
  did: /*#__PURE__*/ v.didString(),
});
const _statusAttrSchema = /*#__PURE__*/ v.object({
  $type: /*#__PURE__*/ v.optional(
    /*#__PURE__*/ v.literal("com.atproto.admin.defs#statusAttr"),
  ),
...
const _threatSignatureSchema = /*#__PURE__*/ v.object({
  $type: /*#__PURE__*/ v.optional(
    /*#__PURE__*/ v.literal("com.atproto.admin.defs#threatSignature"),
  ),
...
export const threatSignatureSchema =
  _threatSignatureSchema as threatSignatureSchema;
...
export interface ThreatSignature extends v.InferInput<
  typeof threatSignatureSchema
> {}
