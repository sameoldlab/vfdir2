      ...
      schema: /*#__PURE__*/ v.object({
        ...
        get result() {
          return /*#__PURE__*/ v.variant([
            resultAvailableSchema,
            resultUnavailableSchema,
          ]);
        },
      }),
    },
...
export const resultAvailableSchema =
  _resultAvailableSchema as resultAvailableSchema;
export const resultUnavailableSchema =
  _resultUnavailableSchema as resultUnavailableSchema;
export const suggestionSchema = _suggestionSchema as suggestionSchema;

export interface ResultAvailable extends v.InferInput<
  typeof resultAvailableSchema
> {}
export interface ResultUnavailable extends v.InferInput<
  typeof resultUnavailableSchema
> {}
