...
const _labelSchema = /*#__PURE__*/ v.object({
  $type: /*#__PURE__*/ v.optional(
    /*#__PURE__*/ v.literal("com.atproto.label.defs#label"),
  ),
  /**
...
const _labelValueDefinitionSchema = /*#__PURE__*/ v.object({
  $type: /*#__PURE__*/ v.optional(
    /*#__PURE__*/ v.literal("com.atproto.label.defs#labelValueDefinition"),
  ),
  /**
...
const _selfLabelSchema = /*#__PURE__*/ v.object({
  $type: /*#__PURE__*/ v.optional(
    /*#__PURE__*/ v.literal("com.atproto.label.defs#selfLabel"),
  ),
  /**
   * The short string name of the value or type of this label.
   * @maxLength 128
...
const _selfLabelsSchema = /*#__PURE__*/ v.object({
  $type: /*#__PURE__*/ v.optional(
    /*#__PURE__*/ v.literal("com.atproto.label.defs#selfLabels"),
  ),
  /**
   * @maxLength 10
   */
...
type labelValueDefinitionStrings$schematype =
  typeof _labelValueDefinitionStringsSchema;
...
export const labelValueDefinitionSchema =
  _labelValueDefinitionSchema as labelValueDefinitionSchema;
...
export interface LabelValueDefinition extends v.InferInput<
  typeof labelValueDefinitionSchema
> {}
export interface LabelValueDefinitionStrings extends v.InferInput<
  typeof labelValueDefinitionStringsSchema
> {}
