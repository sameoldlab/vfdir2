<svg
	...
	><defs
		...
		></path><path id="c" d="M0 19.917v-9.5l.004-.27a9.5 9.5 0 1 1 9.496 9.77H0z"
		></path></defs
	><g fill="none" fill-rule="evenodd"
		...
		></path><g transform="translate(0 11.083)"
			><mask id="b" fill="#fff"><use xlink:href="#a"></use></mask><use
				fill="var(--b7)"
				xlink:href="#a"
			></use><path
				fill="var(--b6)"
		...
		><g transform="translate(19 11.083)"
			><mask id="d" fill="#fff"><use xlink:href="#c"></use></mask><use
				fill="var(--b3)"
				xlink:href="#c"
			></use><path
				fill="var(--b2)"
